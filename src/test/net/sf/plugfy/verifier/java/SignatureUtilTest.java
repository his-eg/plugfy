...
public class SignatureUtilTest implements Repository {
    ...
    public void testCheckSignatureDependencies() {
        ...
        this.clear();
        SignatureUtil.checkSignatureDependencies(this, result, "Ljava/util/List<TCHILD;>;", "Class");
        assertThat(this.requestedClasses.toString(), equalTo("[java.util.List]"));

        this.clear();
        SignatureUtil.checkSignatureDependencies(this, result, "<CHILD:Lde/his/appserver/service/impl/sul/studyhierarchy/container/StudyInfoPermutationTree$TreeNode;>Ljava/lang/Object;", "Class");
        assertThat(this.requestedClasses.toString(), equalTo("[de.his.appserver.service.impl.sul.studyhierarchy.container.StudyInfoPermutationTree$TreeNode, java.lang.Object]"));
